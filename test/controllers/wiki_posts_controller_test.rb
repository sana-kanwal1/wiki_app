...
class WikiPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wiki_post" do
    assert_difference("WikiPost.count") do
      post wiki_posts_url, params: { wiki_post: { author_id: @wiki_post.author_id, description: @wiki_post.description, title: @wiki_post.title } }
    end
  ...
  test "should update wiki_post" do
    patch wiki_post_url(@wiki_post), params: { wiki_post: { author_id: @wiki_post.author_id, description: @wiki_post.description, title: @wiki_post.title } }
